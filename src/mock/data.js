...
export const aboutData = {
  ...
  paragraphOne: 'SUPER ULTRA THUNDER代表取締役社長の\n羽床 大志（はゆか たいし）です！',
  paragraphTwo:
    'この会社で実現したいことはただ一つ、\n「大人になっても遊ぶ」ということです。\n「プライベート」でも「仕事」でも遊びながらしたいという\nわがままな思いを叶えるべくこの会社を設立いたしました。',
  paragraphThree: '',
...
export const projectsData = [
  {
    id: nanoid(),
    img: 'project.jpg',
    title: 'indieindie（インディーインディー）',
    info: 'アーティストとファンで創る新しいコミュニティサービス「indieindie」',
    info2:
